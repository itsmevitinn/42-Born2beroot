...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'my_portfolio_0a39a42382619eb77419_20220629181246_archive.daf';
	const ARCHIVE_SIZE		 = '90719079';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0a39a42-29181246';
    const SECONDARY_PACKAGE_HASH = '5e6b030-29181246';
	const VERSION			 = '1.4.7';
